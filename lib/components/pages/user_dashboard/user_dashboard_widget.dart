                                                ...
                                                child: Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    highlightColor:
                                                        Colors.transparent,
                                                    onTap: () async {
                                                      // Updated on 2024-12-19 15:35 by Gungyun
                                                      // Add debugging and error handling for navigation
                                                      try {
                                                        print('Attempting to navigate to Chat page...');
                                                        print('Chat route name: ${ChatWidget.routeName}');
                                                        print('Chat route path: ${ChatWidget.routePath}');
                                                        
                                                        // Try pushNamed first
                                                        await context.pushNamed(ChatWidget.routeName);
                                                        print('Navigation successful');
                                                      } catch (e) {
                                                        print('Navigation error with pushNamed: $e');
                                                        
                                                        // Try alternative navigation method
                                                        try {
                                                          print('Trying alternative navigation with go...');
                                                          context.go(ChatWidget.routePath);
